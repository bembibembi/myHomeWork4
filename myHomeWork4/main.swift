...
//var words = "Яблоко,Морковь,Огурец,Баклажан,Дом,Машина,Слово,Кошка,Собака,Работа,Друзья,Ноутбук,Бутылка,Клавиатура,Книга,Сумка,Кактус,Растение,Очки,Картинка"
var words =
